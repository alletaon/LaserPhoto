...
/**
* ServoConRemote/IConfigurationPackage/ConfigDataHelper.java .
...
abstract public class ConfigDataHelper
{
  private static String  _id = "IDL:ServoConRemote/IConfiguration/ConfigData:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (ServoConRemote.IConfigurationPackage.ConfigDataHelper.id (), "ConfigData", __typeCode);
    }
    return __typeCode;
  }
