...
/**
* ServoConRemote/IScopeChannelPackage/PointsHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from ServoConRemote_v2.idl
* Wednesday, April 19, 2017 6:32:21 PM MSK
*/

abstract public class PointsHelper
{
  private static String  _id = "IDL:ServoConRemote/IScopeChannel/Points:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (ServoConRemote.IScopeChannelPackage.PointsHelper.id (), "Points", __typeCode);
    }
    return __typeCode;
  }
