...
/**
* ServoConRemote/_s_MotionInfoHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from ServoConRemote_v2.idl
* Wednesday, April 19, 2017 6:32:21 PM MSK
*/

abstract public class _s_MotionInfoHelper
{
  private static String  _id = "IDL:ServoConRemote/s_MotionInfo:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[0] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (ServoConRemote._s_MotionInfoHelper.id (), "s_MotionInfo", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    ServoConRemote._s_MotionInfo value = new ServoConRemote._s_MotionInfo ();
